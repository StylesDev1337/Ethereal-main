...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        EventBus.post(new UpdateEvent(UpdateEvent.Phase.PRE));
        ...
        if (cn.ethereal.module.movement.Noslow.isEnabledStatic() &&
                cn.ethereal.module.movement.Noslow.shouldApply()) {
            float forwardMul = cn.ethereal.module.movement.Noslow.getForwardMultiplier();
            float strafeMul = cn.ethereal.module.movement.Noslow.getStrafeMultiplier();
            boolean allowSprint = cn.ethereal.module.movement.Noslow.allowSprint();

            this.movementInput.moveForward *= forwardMul;
            this.movementInput.moveStrafe *= strafeMul;
        ...
        EventBus.post(new UpdateEvent(UpdateEvent.Phase.POST));
    }
}
